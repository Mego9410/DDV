-- Treat city/county filters as interchangeable (OR) for "in <place>" queries.
-- Reason: DDV geography is messy free text; many places (e.g. Manchester) are stored in `county`.
